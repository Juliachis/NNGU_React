...
interface UsersDataTransformerReturnValue {
...
export const transformUserDataToAntdTableConfig = (
  usersData: IUsers[]
): UsersDataTransformerReturnValue => {
  const usersTableColums = [
    { title: 'Имя', dataIndex: 'name', key: 'name', width: '33.5%' },
    { title: 'Email', dataIndex: 'email', key: 'email', width: '33.5%' },
    { title: 'Телефон', dataIndex: 'phone', key: 'phone', width: '33.5%' },
  ];
